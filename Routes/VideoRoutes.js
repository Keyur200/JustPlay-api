...
const { createVideo, deletevideo, addView, videodetail, trendingVideo, likes, dislikes, allVideos } = require('../Controller/VideoController.js')
const { requireLogin } = require('../MiddleWare/AuthMiddleware.js')
const formidable = require('express-formidable') 
const router = express.Router()

router.post('/uploadvideo',requireLogin, createVideo)
